    ...
    <table>
      ...
      while($row=mysql_fetch_assoc($ret))
      {
        ...
        <tr>
          ...
          {
          ?>
          <td><button name="action" value="<?php echo $row['sid'] ?>" style="background-color: #de0202; color: white;" value="<?php echo $sid ?>" class="change"><span><?php echo $row['status'] ?></span></button></td>
          <?php
          }
          ?>
          </form>
