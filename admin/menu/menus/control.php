...
<div align="center">
<form method="POST">
  <button class="home" name="home"><span>Home</span></button>
</form>
</div>
<div align="center" class="control">
  <table>
    <th>Sr</th><th>Id</th><th>Name</th><th>Semester</th><th>Phone</th><th>Status</th>
    <?php
    $sr=0;
    if($sort=="deactive")
    {
    ...
    <tr>
      ...
      <td style="font-size: 18px">
        ...
        ?> name="action" class="status" value="<?php echo $sid ?>"><span><?php echo $status ?></span></button>
      </td>
      </form>
    </tr>
    <?php
